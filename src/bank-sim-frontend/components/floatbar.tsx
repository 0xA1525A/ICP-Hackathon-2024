...
import { ChartCandlestick, HomeIcon, QrCode, ReceiptText, Settings2 } from 'lucide-react';
const navbarIcons = [
	{
		icon: HomeIcon,
		name: "Home",
...
export const Floatbar: FC = () => {
  return <div className="absolute bottom-3  h-20 max-w-sm w-full left-1/2 -translate-x-1/2 px-3">
